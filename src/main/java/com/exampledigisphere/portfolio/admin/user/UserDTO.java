...
import com.exampledigisphere.portfolio.auth.roles.RoleAuthorityMapper;
...
public class UserDTO implements Serializable {
  ...
  public UserDTO(Long id, String uuid, String name, String email, String password, Role role, Set<FileDTO> files, Boolean edited, Boolean active) {
    this.id = id;
    this.uuid = uuid;
    this.name = name;
    this.email = email;
  ...
  public interface Json {
    ...
    interface All extends Detail, WithFIle {
    }
  }
}
